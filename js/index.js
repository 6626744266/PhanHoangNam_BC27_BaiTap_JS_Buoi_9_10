...
function addEmployee() {
  ...
  var employee = new Employee(tk, name, email, password, datepicker, luongCB, chucVu, gioLam);
...
function display(employees) {
  ...
  <tr>
    ...
    <button class="btn btn-danger" btn-type="delete" onclick="deleteEmployee('${employee.tk}')">Xoá</button></td>
  </tr>
  `
  }
...
function selectEmployee(employeeId) {
  ...
  document.getElementById("tknv").value = employee.tk
...
function updateEmployee() {
  ...
  if ((validationUpdate(employees) != false)) {
    var index = findEmployee(employee.tk)
